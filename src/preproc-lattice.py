"""
This file is largely based on the provided code of 
paper by Sperber et al.
"Self-Attentional Models for Lattice Inputs," ACL 2019
The source code is provided in http://msperber.com/research/acl-lattice-selfatt/
"""
